                                            ...
                                            <div class="form-group has-icon-left">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text" name="name" class="form-control"
                                                        placeholder="Asset Category Name" id="first-name-icon">
                                                    <div class="form-control-icon">
                                                        <i class="fa fa-box"></i>
                                                    </div>
                                                </div>
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a href="#"><button type="button" class="btn btn-primary me-2"
                                            data-bs-toggle="modal" data-bs-target="#showData{{ $cat->id }}">
                                            <i class="fa fa-eye"></i>
                                        </button>
                                    </a>
                                    <a href="#"><button type="button" class="btn btn-warning me-2"
                                            data-bs-toggle="modal" data-bs-target="#editData{{ $cat->id }}">
                                ...
                                <!-- modal show data -->
                                <div class="modal fade text-left" id="showData{{ $cat->id }}" tabindex="-1"
                                ...
                                <!-- modal edit data -->
                                <div class="modal fade text-left" id="editData{{ $cat->id }}" tabindex="-1"
                                    role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                        role="document">
                                        <div class="modal-content">
