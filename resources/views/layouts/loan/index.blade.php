                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-group has-icon-left">
                                                ...
                                                <select class="form-select form-select-lg w-100" name="department_id"
                                                    required>
                                        ...
                                        <div class="form-group has-icon-left">
                                            ...
                                            <select class="form-select form-select-lg w-100" name="category_asset"
                                                required>
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a href="#"><button type="button" class="btn btn-primary me-2"
                                            data-bs-toggle="modal" data-bs-target="#showData{{ $data->id }}">
                                            <i class="fa fa-eye"></i>
                                        </button>
                                    </a>
                                    <a href="#"><button type="button" class="btn btn-warning me-2"
                                            data-bs-toggle="modal" data-bs-target="#editData{{ $data->id }}">
                                ...
                                <!-- modal show data -->
                                <div class="modal fade text-left" id="showData{{ $data->id }}" tabindex="-1"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group has-icon-left">
                                                                ...
                                                                <select class="form-select form-select-lg w-100"
                                                                    value="{{ $data->category_asset }}" disabled>
                                                                    <option value="AP"
                                ...
                                <!-- modal edit data -->
                                <div class="modal fade text-left" id="editData{{ $data->id }}" tabindex="-1"
                                    role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                        role="document">
                                        <div class="modal-content">
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="form-group has-icon-left">
                                                                    ...
                                                                    <div class="position-relative">
                                                                        <input readonly type="text"
                                                                            value="{{ $data->equipment }}"
                                                                            name="equipment" class="form-control"
                                                                            id="mobile-id-icon">
                                                                        <div class="form-control-icon">
                                                                            <i class="bi bi-pen"></i>
                                                                        </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group has-icon-left">
                                                                    <label for="first-name-icon">Detail Loan</label>
                                                                    <div class="position-relative">
                                                                        <input type="text" name="detail_loan"
                                                                            class="form-control" required
                                                                            value="{{ $data->detail_loan }}">
                                                                        <div class="form-control-icon">
                                                                            <i class="fa fa-user"></i>
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <div class="position-relative mb-2">
                                                                    <input readonly type="text"
                                                                        value="{{ $data->loan_date }}"
                                                                        name="loan_date" class="form-control"
                                                                        placeholder="Choose a date"
                                                                        id="password-id-icon" required>
                                                                </div>
                                                            </div>
