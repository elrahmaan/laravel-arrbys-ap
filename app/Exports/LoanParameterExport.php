...
class LoanParameterExport implements WithHeadings, ShouldAutoSize, WithEvents, WithHeadingRow, WithColumnWidths
{
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class    => function (AfterSheet $event) use ($styleArray, $styleTitle, $styleTitleDate, $styleContent, $center) {
                ...
                $cell = 11;
                $i = 1;
                $loan_date = Loan::getDateParameter($this->fromDates, $this->toDates);
                // dd($loan_date);
